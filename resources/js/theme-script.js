...
document.querySelector("html").setAttribute('data-color', localStorage.getItem('color') || 'lunargreen');
...
<div class="sidebar-contact ">
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        function resetThemeAndSidebarThemeAndColorAndBg() {
            setThemeAndSidebarTheme('light', 'light', 'lunargreen', 'default', 'white', 'white', 'default', 'fluid', 'enable');
            document.body.removeAttribute('data-sidebarbg');
            document.body.removeAttribute('data-topbarbg');
    
            document.getElementById('lightTheme').checked = true;
            document.getElementById('lightSidebar').checked = true;
            document.getElementById('lunargreenColor').checked = true;
