        ...
        <div class="page-header">
            <div class="add-item d-flex">
                <div class="page-title">
                    <h4 class="fw-bold">{{__("application_lang.app_menus_lbl_tb_col_roles")}}</h4>
                    <h6>{{__("application_lang.app_menus_lbl_btn_actions_manage")}} {{__("application_lang.app_lbl_yours")}} {{__("application_lang.app_menus_lbl_tb_col_roles")}}</h6>
                </div>
            </div>
            ...
            <div class="page-btn">
                @can('role.create')
                    <a href="{{ secure_route('admin.rol.addEdit',['id' => encrypt_param(0)]) }}" class="btn btn-primary ">
                        <i class="ti ti-circle-plus me-1"></i>
                        {{__("application_lang.app_menus_lbl_menus_roles_add")}}
                    </a>
        ...
        <div class="card">
            ...
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table datatable" id="dt_Rol">
                        <thead class="thead-light">
                            <tr>                                
                                <th>{{__("application_lang.app_menus_lbl_tb_col_name")}} </th>
                                <th>{{__("application_lang.app_menus_lbl_guard_name")}}</th>                                    
