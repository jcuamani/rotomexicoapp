        ...
        <div class="page-header">
            <div class="add-item d-flex">
                <div class="page-title">
                    <h4 class="fw-bold">{{__("application_lang.application_shop_account_types")}}</h4>
                    <h6>{{__("application_lang.app_menus_lbl_btn_actions_manage")}} {{__("application_lang.app_lbl_yours")}} {{__("application_lang.application_shop_account_types")}}</h6>
                </div>
            </div>
            ...
            <div class="page-btn">
                @can('customer_cat_shopaccounttype.create')
                    <a href="{{ secure_route('customer.cat.shopaccounttype.addEdit',['id' => encrypt_param(0)]) }}" class="btn btn-primary ">
                        <i class="ti ti-circle-plus me-1"></i>
                        {{__("application_lang.application_add_new_shop_account_type")}}
                    </a>
        ...
        <div class="card">
            ...
            <div class="card-body p-0">
                <div class="table-responsive" >
                    <table class="table datatable" id="dt_ShopAccountType">
                        <thead class="thead-light">
                            <tr>                                
                                <th>{{__("application_lang.app_menus_lbl_tb_col_code")}} </th>
                                <th>{{__("application_lang.application_description")}} </th>
